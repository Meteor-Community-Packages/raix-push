...
Push.Configure = function(options) {
    ...
    // The rest has not been refactored so i'm going to return for now!
    return false;
    
    
    
    /*
     * refactored up to this point... PR open.
     * have a look at that log, hopefullyt his is the style you are looking for.
