...
Push.Configure = function(options) {
    ...
    self.sendAPN = function(userToken, notification) {
      ...
      // adds category support for iOS8 custom actions as described here:
        ...
        console.log('PUSH DEBUG: connections[key]', Push.Connections[key]);
        console.log('PUSH DEBUG: connections[key].apnConnection', Push.Connections[key].apnConnection);
        console.log('PUSH DEBUG: note', note);
        console.log('PUSH DEBUG: myDevice', myDevice);

        var result = Push.Connections[key].apnConnection.pushNotification(note, myDevice);
